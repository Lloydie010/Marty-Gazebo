...
int main(int argc, char **argv)
{
    ...
    //loadTrajectoryFromFile("/home/ubuntu/Downloads/Trajectories/T/trajectoryHop3T.csv", torques, Tdurations);
    loadTrajectoryVel("/home/ubuntu/Downloads/Trajectories/dq/trajectoryHop11dq.csv", trajectories, velocities, durations);
    durations[0] = 0.1;
    // for (int k = 0; K < 20; k++) {
    //     velocities[k][:] = velocities[k][:]*2;
    // }
    ...
    std::cin.get();
    cout << "Executing..." << endl;
    //moveAllPositionMult(trajectories, durations);
    //moveAllPosVel(trajectories, velocities, durations);
    moveAllPosVelInt(trajectories, velocities, durations);
